...
-- storage pointers (T-CAT.7, docs/spec/chat_attachments.md §9).
--
...
-- are stored, then flipped to 'READY' or 'FAILED' once the AST-build +
-- encrypt + artifact-store steps finish (service layer, T-CAT.11).
--
