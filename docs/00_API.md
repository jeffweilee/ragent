...
- `POST /chatagent/v3/session/continue` — body `{session}`, proxied unchanged to `${CHATAGENT_SESSION_API_URL}/continue`; same error mapping as the other session routes (`502 CHATAGENT_UPSTREAM_ERROR` / `504 CHATAGENT_TIMEOUT`).
